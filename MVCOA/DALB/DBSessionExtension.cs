...
namespace DALMSSQL
{
	public partial class DBSession:IDBSession
    {
		...
		#region 10 数据接口 IWF_AutoTransactNodeDAL
		...
		#region 11 数据接口 IWF_BillFlowNodeDAL
		...
		#region 12 数据接口 IWF_BillFlowNodeRemarkDAL
		...
		#region 13 数据接口 IWF_BillStateDAL
		...
		#region 15 数据接口 IWF_NodeStateDAL
		...
		#region 16 数据接口 IWF_WorkFlowDAL
		...
		#region 17 数据接口 IWF_WorkFlowNodeDAL
